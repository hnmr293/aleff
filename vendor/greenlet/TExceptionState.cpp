...
void
ExceptionState::clone_from(const ExceptionState& other) noexcept
{
    this->exc_info = other.exc_info;
    this->exc_state = other.exc_state;
    Py_XINCREF(this->exc_state.exc_value);
#if !GREENLET_PY311
    Py_XINCREF(this->exc_state.exc_type);
    Py_XINCREF(this->exc_state.exc_traceback);
#endif
}
